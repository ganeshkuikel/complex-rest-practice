"""
Django settings for complexrest project.
...
SECRET_KEY = '4q2kk&cxul)1+-$9*92*y_e&a#$awv_lvoyxp3xys7*+=b5!s3'
...
WSGI_APPLICATION = 'complexrest.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'drone_app',  # Replace username with your desired user name
        'USER': 'postgres',
